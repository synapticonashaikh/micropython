...
//
// --af boards/stm32f446_af.csv
// --board boards/NUCLEO_F446RE/pins.csv
...
const pin_af_obj_t pin_A1_af[] = {
  ...
  //(10, SAI     ,  2, MCLK_B    , SAI2    ), // SAI2_MCLK_B
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};
...
const pin_af_obj_t pin_A6_af[] = {
  ...
  //(13, DCMI    ,  0, PIXCLK    , DCMI    ), // DCMI_PIXCLK
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};
...
const pin_obj_t pin_B2_obj = PIN(B, 2, pin_B2_af, 0, 0);
...
const pin_af_obj_t pin_B5_af[] = {
  ...
  //(12, FMC     ,  0, SDCKE1    , FMC     ), // FMC_SDCKE1
...
// const pin_af_obj_t pin_C0_af[] = {
  //( 6, SAI     ,  1, MCLK_B    , SAI1    ), // SAI1_MCLK_B
...
#endif
#if defined(MICROPY_HW_I2S3)
  AF( 5, I2S     ,  3, SD        , I2S3    ), // I2S3_SD
#endif
  //( 6, SAI     ,  1, SD_A      , SAI1    ), // SAI1_SD_A
#if defined(MICROPY_HW_SPI2_SCK)
  AF( 7, SPI     ,  2, MOSI      , SPI2    ), // SPI2_MOSI
#endif
#if defined(MICROPY_HW_I2S2)
  AF( 7, I2S     ,  2, SD        , I2S2    ), // I2S2_SD
#endif
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};

const pin_obj_t pin_C1_obj = PIN(C, 1, pin_C1_af, PIN_ADC1 | PIN_ADC2 | PIN_ADC3, 11);
...
const pin_af_obj_t pin_C3_af[] = {
  ...
  //(12, FMC     ,  0, SDCKE0    , FMC     ), // FMC_SDCKE0
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};
...
#endif
  //( 8, SPDIF   ,  0, RX2       , SPDIF   ), // SPDIF_RX2
  //(12, FMC     ,  0, SDNE0     , FMC     ), // FMC_SDNE0
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};

const pin_obj_t pin_C4_obj = PIN(C, 4, pin_C4_af, PIN_ADC1 | PIN_ADC2, 14);

const pin_af_obj_t pin_C5_af[] = {
#if defined(MICROPY_HW_UART3_TX)
  AF( 7, USART   ,  3, RX        , USART3  ), // USART3_RX
#endif
  //( 8, SPDIF   ,  0, RX3       , SPDIF   ), // SPDIF_RX3
  //(12, FMC     ,  0, SDCKE0    , FMC     ), // FMC_SDCKE0
  //(15, EVENTOUT,  0,           , EVENTOUT), // EVENTOUT
};

const pin_obj_t pin_C5_obj = PIN(C, 5, pin_C5_af, PIN_ADC1 | PIN_ADC2, 15);

const pin_af_obj_t pin_C6_af[] = {
  AF( 2, TIM     ,  3, CH1       , TIM3    ), // TIM3_CH1
  AF( 3, TIM     ,  8, CH1       , TIM8    ), // TIM8_CH1
  //( 4, FMPI2C  ,  1, SCL       , FMPI2C1 ), // FMPI2C1_SCL
#if defined(MICROPY_HW_I2S2)
...
const pin_af_obj_t pin_C7_af[] = {
  ...
  //( 4, FMPI2C  ,  1, SDA       , FMPI2C1 ), // FMPI2C1_SDA
#if defined(MICROPY_HW_SPI2_SCK)
  AF( 5, SPI     ,  2, SCK       , SPI2    ), // SPI2_SCK
#endif
#if defined(MICROPY_HW_I2S2)
...
const pin_af_obj_t pin_C8_af[] = {
  ...
  AF( 7, UART    ,  5, RTS       , UART5   ), // UART5_RTS
#endif
#if defined(MICROPY_HW_UART6_TX)
...
#if defined(MICROPY_HW_UART5_TX)
  AF( 7, UART    ,  5, CTS       , UART5   ), // UART5_CTS
#endif
...
STATIC const mp_rom_map_elem_t pin_board_pins_locals_dict_table[] = {
  { MP_ROM_QSTR(MP_QSTR_D0), MP_ROM_PTR(&pin_A3_obj) },
  { MP_ROM_QSTR(MP_QSTR_D1), MP_ROM_PTR(&pin_A2_obj) },
  { MP_ROM_QSTR(MP_QSTR_D2), MP_ROM_PTR(&pin_A10_obj) },
  { MP_ROM_QSTR(MP_QSTR_D3), MP_ROM_PTR(&pin_B3_obj) },
  { MP_ROM_QSTR(MP_QSTR_D4), MP_ROM_PTR(&pin_B5_obj) },
  { MP_ROM_QSTR(MP_QSTR_D5), MP_ROM_PTR(&pin_B4_obj) },
  { MP_ROM_QSTR(MP_QSTR_D6), MP_ROM_PTR(&pin_B10_obj) },
  { MP_ROM_QSTR(MP_QSTR_D7), MP_ROM_PTR(&pin_A8_obj) },
  { MP_ROM_QSTR(MP_QSTR_D8), MP_ROM_PTR(&pin_A9_obj) },
  { MP_ROM_QSTR(MP_QSTR_D9), MP_ROM_PTR(&pin_C7_obj) },
  { MP_ROM_QSTR(MP_QSTR_D10), MP_ROM_PTR(&pin_B6_obj) },
  { MP_ROM_QSTR(MP_QSTR_D11), MP_ROM_PTR(&pin_A7_obj) },
  { MP_ROM_QSTR(MP_QSTR_D12), MP_ROM_PTR(&pin_A6_obj) },
  { MP_ROM_QSTR(MP_QSTR_D13), MP_ROM_PTR(&pin_A5_obj) },
  { MP_ROM_QSTR(MP_QSTR_D14), MP_ROM_PTR(&pin_B9_obj) },
  { MP_ROM_QSTR(MP_QSTR_D15), MP_ROM_PTR(&pin_B8_obj) },
  { MP_ROM_QSTR(MP_QSTR_A0), MP_ROM_PTR(&pin_A0_obj) },
  { MP_ROM_QSTR(MP_QSTR_A1), MP_ROM_PTR(&pin_A1_obj) },
  { MP_ROM_QSTR(MP_QSTR_A2), MP_ROM_PTR(&pin_A4_obj) },
  { MP_ROM_QSTR(MP_QSTR_A3), MP_ROM_PTR(&pin_B0_obj) },
  { MP_ROM_QSTR(MP_QSTR_A4), MP_ROM_PTR(&pin_C1_obj) },
  { MP_ROM_QSTR(MP_QSTR_A5), MP_ROM_PTR(&pin_C0_obj) },
  ...
  { MP_ROM_QSTR(MP_QSTR_LED), MP_ROM_PTR(&pin_A5_obj) },
  { MP_ROM_QSTR(MP_QSTR_SW), MP_ROM_PTR(&pin_C13_obj) },
};
...
const pin_obj_t * const pin_adc3[14] = {
  [0] = &pin_A0_obj,
  [1] = &pin_A1_obj,
  [2] = &pin_A2_obj,
  [3] = &pin_A3_obj,
