...
#undef MODULE_DEF_MP_QSTR__ONEWIRE
#define MODULE_DEF_MP_QSTR__ONEWIRE { MP_ROM_QSTR(MP_QSTR__onewire), MP_ROM_PTR(&mp_module_onewire) },
...
extern const struct _mp_obj_module_t mp_module_uplatform;
#undef MODULE_DEF_MP_QSTR_UPLATFORM
#define MODULE_DEF_MP_QSTR_UPLATFORM { MP_ROM_QSTR(MP_QSTR_uplatform), MP_ROM_PTR(&mp_module_uplatform) },
...
#undef MODULE_DEF_MP_QSTR_UTIMEQ
#define MODULE_DEF_MP_QSTR_UTIMEQ { MP_ROM_QSTR(MP_QSTR_utimeq), MP_ROM_PTR(&mp_module_utimeq) },
...
#define MICROPY_REGISTERED_MODULES \
    ...
    MODULE_DEF_MP_QSTR_UTIMEQ \
    MODULE_DEF_MP_QSTR_UZLIB \
    MODULE_DEF_MP_QSTR__ONEWIRE \
